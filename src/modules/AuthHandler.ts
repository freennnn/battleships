...
import { ClientInfo, RegistrationData, RegistrationResponse } from "../types/user.types.js";
...
export class AuthHandler {
    ...
    handleRegistration(ws: WebSocket, data: WebSocketMessage, clientId: string): void {
        try {
            ...
            const responseData = this.processAuth(providedName, providedPassword, clientId, currentClient);
